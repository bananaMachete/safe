...
class List extends Component {
  ...
  columns = [
    ...
    },
    {
      ...
      render:(text) => {
        return text === '0'? (<Tag color='green'>待审核</Tag>): text === '1' ? (<Tag color='orange'>已审核</Tag>) : (<Tag color='green'>已完成</Tag>)
      }
    },
    {
      title: '备注',
    ...
    },
    {
      ...
      render: (text, record) => (
        <span>
          ...
          <Divider type="vertical" />
          <a onClick={this.handleDetail.bind(this,record)}>详情</a>
        </span>
      ),
    }
  ];
  ...
  handleEditorInfo(data){
    this.props.history.push({ pathname: '/planManage/patrolPlan/add', state: { isAdd:0,data:data } })
  }
  //查看
  handleDetail(data){
